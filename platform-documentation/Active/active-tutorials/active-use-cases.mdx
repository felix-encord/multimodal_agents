...
5. **Sent to Annotate:** Alex goes to the _Collections_ page, selects the _Roadsigns_ Collection and clicks **Create Dataset**. Active creates the dataset and [a new Project in Annotate](/platform-documentation/Annotate/annotate-projects/annotate-create-projects). Alex then configures the workflow, annotators, and reviewers for the Project in Annotate.
